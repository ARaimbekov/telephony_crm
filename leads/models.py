...
class Employee(models.Model):
    ...
    patronymic_name = models.CharField(max_length=150, blank=True, verbose_name='Отчество')
    sam_account_name = models.CharField(max_length=150, blank=True, unique=True, verbose_name='Логин AD')
