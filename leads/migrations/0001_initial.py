    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atc', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='leads.atc', verbose_name='Atc сервер')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='leads.company', verbose_name='Компания')),
                ('phone_model', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='leads.apparats', verbose_name='Модель телефона')),
