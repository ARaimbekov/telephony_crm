# Generated by Django 3.1.4 on 2022-09-20 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Company', models.ManyToManyField(null=True, to='leads.Company', verbose_name='Компания')),
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.agent', verbose_name='Оператор')),
